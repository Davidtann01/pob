...
Scanner input = new Scanner(System.in)
        String traffic;
        int code = 0;
        System.out.println("Pilih Warna kode 1 sampai 3");    
        code = input.nextInt();
        
        if(code == 1)
        traffic = "Lampu selanjutnya adalah Hijau";
        else if(code == 2)
        traffic = "Lampu selanjutnya adalah Kuning";
        else if(code == 3)
        traffic = "Lampu selanjutnya adalah Merah";
        else
        traffic = "Warna tidak tersedia";
