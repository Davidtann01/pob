...
System.out.print("Pilih nomor 1 sampai 10: ");
int userNum = numberScanner.nextInt();
Random rnd = new Random();
int winningNum = rnd.nextInt(10)+1;
System.out.println("Nomor Kamu: "+ userNum);
System.out.println("Nomor terpilih adalah "+winningNum);
